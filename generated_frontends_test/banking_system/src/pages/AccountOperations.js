...
const AccountOperations = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Account Operations</h1>
        <p className="mt-2 text-gray-600">
          Manage account operations on the Aleo blockchain
        </p>
      </div>
      ...
      <div className="space-y-6">
          ...
          <form onSubmit={(e) => handleSubmit(e, 'freeze_account')} className="space-y-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={(e) => handleSubmit(e, 'unfreeze_account')} className="space-y-4">
            <p className="text-gray-600">This function requires private parameters</p>
            <button
              type="submit"
              disabled={loading}
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={(e) => handleSubmit(e, 'create_account')} className="space-y-4">
            <p className="text-gray-600">This function requires private parameters</p>
            <button
              type="submit"
              disabled={loading}

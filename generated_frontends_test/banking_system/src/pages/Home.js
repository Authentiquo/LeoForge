        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Deposit Public</span></li>
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Withdraw Public</span></li>

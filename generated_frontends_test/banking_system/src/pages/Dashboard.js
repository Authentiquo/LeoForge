    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold mb-2">Public Balances</h3>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold mb-2">Account Exists</h3>
          <p className="text-sm text-gray-600 mb-4">
            field → bool
          </p>
          <div className="text-2xl font-bold text-aleo-blue">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold mb-2">System Paused</h3>
          <p className="text-sm text-gray-600 mb-4">
            field → bool
          </p>
          <div className="text-2xl font-bold text-aleo-blue">

    ...
    <div className="space-y-12">
      ...
      <section className="grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-gray-600">
            11 mappings and 2 record types
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Initialize Collection</span></li>
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Mint Nft</span></li>
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Create Claim Pool</span></li>
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Purchase Claim Ticket</span></li>
              <li className="flex items-center space-x-2"><span className="text-aleo-blue">•</span><span>Claim Random Nft</span></li>
            </ul>
          </div>
          <div>
